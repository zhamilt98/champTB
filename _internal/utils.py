...
NATURES = {
    "Lonely (+Atk, -Def)": {"plus": "atk", "minus": "def"},
    "Brave (+Atk, -Spe)": {"plus": "atk", "minus": "spe"},
    "Adamant (+Atk, -SpA)": {"plus": "atk", "minus": "spa"},
    "Naughty (+Atk, -SpD)": {"plus": "atk", "minus": "spd"},
    "Bold (+Def, -Atk)": {"plus": "def", "minus": "atk"},
    "Relaxed (+Def, -Spe)": {"plus": "def", "minus": "spe"},
    "Impish (+Def, -SpA)": {"plus": "def", "minus": "spa"},
    "Lax (+Def, -SpD)": {"plus": "def", "minus": "spd"},
    "Timid (+Spe, -Atk)": {"plus": "spe", "minus": "atk"},
    "Hasty (+Spe, -Def)": {"plus": "spe", "minus": "def"},
    "Jolly (+Spe, -SpA)": {"plus": "spe", "minus": "spa"},
    "Naive (+Spe, -SpD)": {"plus": "spe", "minus": "spd"},
    "Modest (+SpA, -Atk)": {"plus": "spa", "minus": "atk"},
    "Mild (+SpA, -Def)": {"plus": "spa", "minus": "def"},
    "Quiet (+SpA, -Spe)": {"plus": "spa", "minus": "spe"},
    "Rash (+SpA, -SpD)": {"plus": "spa", "minus": "spd"},
    "Calm (+SpD, -Atk)": {"plus": "spd", "minus": "atk"},
    "Gentle (+SpD, -Def)": {"plus": "spd", "minus": "def"},
    "Sassy (+SpD, -Spe)": {"plus": "spd", "minus": "spe"},
    "Careful (+SpD, -SpA)": {"plus": "spd", "minus": "spa"},
}
